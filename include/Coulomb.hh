...
//#include "StopSimCoulexMessenger.hh"
//#include "StopSimHisto.hh"

//class StopSimCoulexMessenger;
struct isotope;
struct xsecentry;
struct xsecdata;
...
class Coulomb : public G4VDiscreteProcess
{
public:

  // Constructor
  Coulomb(const G4String& processName ="InelasticCoulomb");
...
private:
  ...
  //messenger
  //StopSimCoulexMessenger* messenger;

  // Hide assignment operator as private
  Coulomb& operator=(const Coulomb &right);
