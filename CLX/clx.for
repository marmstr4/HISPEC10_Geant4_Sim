...
C
	...
	REAL LLMAX,MEM(50,50,5),MEMC(50,20,5),ME,R_QLM(5,5),I_QLM(5,5)
	...
	REAL*8 R_TE,R_CSUM
	REAL I_EX,N_FAC
	REAL R_RHOB(50,3,5),I_RHOB(50,3,5),R_RHOC(50,3,5),I_RHOC(50,3,5)
	...
	DIMENSION SPIN(50),EN(50),IPAR(50),RK(50),LAMDA(5),ETAN(50),CPSI(5)
	DIMENSION IFAC(50),LDNUM(5,50),LEAD(50,20,5),CAT(2000),PSI(50,20,5)
...
C
	...
	IF ( NZMAX .GT. 32767 ) THEN
	 WRITE ( 6,*) ' ***FATAL*** MORE THAN 32767 ELEMENTS IN ZETA ARRAY!'
	 STOP
	END IF
	WRITE ( 6,27 ) NZMAX
...
C
	      ...
	      IF ( FF .LE. ACC050 ) THEN
	       ...
	       IF ( OUCNTL .NE. 0 ) THEN
	        WRITE ( 6,35 ) W,D2W
35	FORMAT ( ' AT W = ',F7.3,' STEPWIDTH WAS DOUBLED TO BE ',F8.5 )
	       END IF
	      END IF
	      IF ( FF .GT. ACCUR ) THEN
	       DWFLAG=1
	       ...
	       IF ( OUCNTL .NE. 0 ) THEN
	        WRITE ( 6,36 ) W,D2W
36	FORMAT ( ' AT W = ',F7.3,' STEPWIDTH WAS HALVED TO BE ',F8.5 )
	       END IF
	      END IF
	     END IF
C
...
40	 FORMAT ( ' INTEGRATION COMPLETE'//' LARGEST DEVIATION FROM 1 = ',
	1G11.4/' FINAL DEVIATION FROM 1 = ',G11.4 )
	END IF
C
